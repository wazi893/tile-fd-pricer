...
fn main() {
    ...
    println!("{:<22}{:>12.6}{:>12.6}{:>12.6}", "Black–Scholes (exact)", exact.price, exact.delta, exact.gamma);
    println!("{:<22}{:>12.6}{:>12.6}{:>12.6}", "FD European", euro.price, euro.delta, euro.gamma);
    println!("{:<22}{:>12.6}{:>12}{:>12}", "FD American", amer.price, "", "");
    println!();
    println!("European price error vs closed form : {:.2e}", (euro.price - exact.price).abs());
    println!("American early-exercise premium      : {:.6}", amer.price - euro.price);
}
